...
class Map extends React.Component{
	...
	render(){
		...
		return(
			...
			<g className="state"    onMouseOver={ e=> this.hoverChangeBackground(e)} 
				
			>

			  <path id="AK" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="HI" 
			  onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="AL" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="AR" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="AZ" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="CA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="CO" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  d="M380.2 235.5l-36-3.5-79.1-8.6-2.2 22.1-7 50.4-1.9 13.7 34 3.9 37.5 4.4 34.7 3 14.3.6z">
			    <title>Colorado</title>
			  </path>
			  <path id="CT" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="DE" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="FL" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="GA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="IA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="ID" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="IL" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="IN" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="KS" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="KY" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="LA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MD" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="ME" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MI" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MN" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MO" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MS" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="MT" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NC" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="ND" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NE" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NH" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NJ" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NM" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NV" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="NY" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="OH" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="OK" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="OR" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="PA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="RI" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  d="M873.6 175.7l-.8-4.4-1.6-6 5.7-1.5 1.5 1.3 3.4 4.3 2.8 4.4-2.8 1.4-1.3-.2-1.1 1.8-2.4 1.9-2.8 1.1z">
			    <title>Rhode Island</title>
			  </path>
			  <path id="SC" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="SD" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="TN" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="TX" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="UT" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="VA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="VT" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="WA" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="WI" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="WV" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  ...
			  <path id="WY" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			  d="M353 161.9l-1.5 25.4-4.4 44-2.7-.3-83.3-9.1-27.9-3 2-12 6.9-41 3.8-24.2 1.3-11.2 48.2 7 59.1 6.5z">
			    <title>Wyoming</title>
			  </path>
			  <g id="DC">
			    <title>District of Columbia</title>
			    <path id="DC1" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))} 
			    d="M801.8 253.8l-1.1-1.6-1-.8 1.1-1.6 2.2 1.5z"/>
			    <circle id="DC2" onClick={(e)=>this.onMapClick(e.currentTarget.getAttribute("id"))}
			    stroke="#FFFFFF" strokeWidth="1.5" cx="801.3" cy="251.8" r="5" opacity="1"/> 
			  </g>
			</g>
